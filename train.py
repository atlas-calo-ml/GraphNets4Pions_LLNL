...
if __name__=="__main__":
    ...
    model = models.EncodeProcessDecode(global_output_size=1, 
    ...
    save_dir = 'results/encodeDecode_'+time.strftime("%Y%m%d")+'_'+os.getenv('HOSTNAME')+'_'+particle_type
    ...
    def create_loss(targets, output):
        ...
        targets = np.repeat(targets, repeats=output_globals.shape[1], axis=-1)
