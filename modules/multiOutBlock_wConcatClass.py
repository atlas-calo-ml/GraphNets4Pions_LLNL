...
class MultiOutBlockConcatClassModel(snt.Module):
    """
    ...
    def __init__(self,
               ...
               num_outputs=1,
               model_config=None,
               name="MultiOutBlockConcatClassModel"):
        super(MultiOutBlockConcatClassModel, self).__init__(name=name)
    ...
    def __call__(self, input_op):
        ...
        class_output = self._output_transform[1](stacked_latent)
        latent_wClass = utils_tf.concat([stacked_latent, class_output], axis=1)
        regress_output = self._output_transform[0](latent_wClass)
