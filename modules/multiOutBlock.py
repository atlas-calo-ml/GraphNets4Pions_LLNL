    ...
    def __init__(self,
        ...
        for i in range(self._num_outputs):
            if node_output_size is None:
                ...
                node_fn.append(lambda: snt.Linear(node_output_size, name="node_output_"+str(i)))

            if global_output_size is None:
                global_fn.append(None)
            else:
        ...
        for i in range(self._num_outputs):
            self._output_transform.append(modules.GraphIndependent(
                edge_fn, node_fn[i], global_fn[i], name="network_output_"+str(i)))
