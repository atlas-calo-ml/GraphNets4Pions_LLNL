...
class MultiOutBlockWeightedRegressModel(snt.Module):
    """
    ...
    def __init__(self,
               ...
               num_outputs=1,
               model_config=None,
               name="MultiOutBlockWeightedRegressModel"):
        super(MultiOutBlockWeightedRegressModel, self).__init__(name=name)
