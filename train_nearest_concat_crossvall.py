...
import modules.multiOutBlock_wConcatClass as models
...
if __name__=="__main__":
    ...
    save_dir = train_config['save_dir'] + '/Concat_' + args.config.replace('.yaml','').split('/')[-1]
    ...
    model = models.MultiOutBlockConcatClassModel(global_output_size=1, num_outputs=2, model_config=model_config)
